...
**RADAR-API** is a Python package designed to make your life easier, whether you aim to download some weather radar data, search for specific files, or jump into scientific analysis.
...
The map here below displays the radars currently accessible through RADAR-API.

.. image:: /static/radar_api_coverage.png
