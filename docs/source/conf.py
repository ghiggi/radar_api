...
sys.path.insert(0, os.path.abspath("../.."))
sys.path.insert(0, os.path.join(os.path.abspath("../.."), "radar_api"))
...
html_title = "RADAR-API"
html_theme_options = {
    "repository_url": "https://github.com/ghiggi/radar_api",
...
def run_apidoc(_):
    ...
    module_dir = os.path.join(cur_dir, "..", "..", "radar_api")
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(radar_api.__file__))

    if "+" in radar_api.__version__:
        return f"https://github.com/ghiggi/radar_api/blob/main/radar_api/{fn}{linespec}"
    else:
        return f"https://github.com/ghiggi/radar_api/blob/" f"v{radar_api.__version__}/radar_api/{fn}{linespec}"
